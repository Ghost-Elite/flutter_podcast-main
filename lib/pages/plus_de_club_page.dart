...
class PlusDeClubsPage extends StatefulWidget {
  final AssetsAudioPlayer player;
  var dataUrlClub;
  Club? club;
  List<DataClub> clubdata = [];
  bool isLoading;
  PlusDeClubsPage({Key? key,required this.player,this.dataUrlClub,this.club,required this.clubdata,required this.isLoading}) : super(key: key);

  @override
  State<PlusDeClubsPage> createState() => _PlusDeClubsPageState();
}

class _PlusDeClubsPageState extends State<PlusDeClubsPage> {
